    ...
    <Link
      ...
      className={`${
        location.pathname === "/"
          ...
          : "py-2 px-2 hover:border-orange-700 hover:rounded-md hover:text-orange-500 hover:border-b-2"
      }`}
    >
      Home
    </Link>
          ...
          <ul className="flex items-center space-x-4 md:space-x-8 mt-4 md:mt-0">
            {currentUser ? (
              ...
              <li>
                ...
                <button className="bg-orange-400 rounded-md px-2 py-2 font-bold transform transition-transform duration-200 hover:scale-105 hover:z-10">
  Sign/Signup
</button>
