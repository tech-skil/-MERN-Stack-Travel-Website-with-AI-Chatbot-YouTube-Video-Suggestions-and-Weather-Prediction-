              ...
              <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                  <div className="mb-8 md:mb-0">
                    ...
                    <p className="text-sm">
                      Triplo – travels, act as digital portals, offering a seamless fusion of information and inspiration that makes exploring the world's wonders and planning travel from your screen an effortless and exciting experience.
                    </p>
                  </div>
                  <div>
