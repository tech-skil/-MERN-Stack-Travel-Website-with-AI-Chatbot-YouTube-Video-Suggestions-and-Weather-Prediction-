...
const Privacy = () => {
  return (
    <div className="p-6 max-w-3xl mx-auto py-28">
      ...
      <ul className="list-disc list-inside mb-6">
        ...
        <li><strong>Functionality Cookies</strong>
          <p className="ml-4 text-sm">Type: Persistent Cookies<br /> Administered by: Us<br /> Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
        </li>
      </ul>
      <p className="mb-6">
