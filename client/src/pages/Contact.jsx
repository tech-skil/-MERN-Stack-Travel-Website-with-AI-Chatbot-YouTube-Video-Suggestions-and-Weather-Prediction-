...
const About = () => {
  ...
  <div class="text-center mb-10">
    <h2 class="text-orange-500 font-semibold uppercase">CONTACT US</h2>
    <h1 class="text-4xl font-bold mt-2">
      <span class="text-orange-500">CONTACT</span> For Any Query
    </h1>
  </div>
  ...
  <div class="flex flex-col md:flex-row gap-8">
    ...
    <div class="w-full md:w-1/2">
      <form class="space-y-4">
        ...
        <button
          type="submit"
          class="w-full bg-orange-500 text-white py-2 px-4 rounded-md hover:bg-orange-600 transition duration-300 ease-in-out"
        >
          SEND MESSAGE
        </button>
      </form>
